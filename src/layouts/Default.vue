...
<template>
	<n-layout has-sider style="height: 100vh">
		...
		<n-drawer v-else v-model:show="appStore.showSidebar" :width="260" placement="left">
			<n-drawer-content closable body-content-style="padding:0">
				<template #header>
					<n-space :wrap="false" align="center">
						<div class="quasar-icon-64" style="width: 48px; height: 52px" />
						<n-h3 style="margin: 0">
							<n-text type="primary" style="font-weight: bold">
								{{ appStore.appName }}
							</n-text>
						</n-h3>
					</n-space>
